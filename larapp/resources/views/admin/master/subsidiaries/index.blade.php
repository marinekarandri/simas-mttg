<x-admin.layout title="Master - Subsidiaries">
  <div class="p-4">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px">
      <div>
        <h3>Subsidiaries</h3>
        <div style="font-size:12px;color:#6b7280;margin-top:4px">Master · <a href="{{ route('dashboard') }}">Dashboard</a> / <strong>Subsidiaries</strong></div>
      </div>
      <div><a href="{{ route('admin.subsidiaries.create') }}" class="btn btn-sm btn-primary">Create Subsidiary</a></div>
    </div>

                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                                ...
                                <div class="single_advisor_details_info">
                                    <h6>Nazrul Islam</h6>
                                    <p class="designation">BKM Masjid Takkhobar</p>
                                </div>
                            </div>
                        </div>

                        <!-- Detail card beside advisor -->
                        <div class="col-12 col-sm-6 col-lg-9">
                            <div class="card card-sm detail-meta mb-3 p-3">
                                <h3 class="mb-1">Masjid Takkhobbar</h3>
                                <div class="text-muted small">SBU Ketintang, Surabaya, Jawa Timur</div>
